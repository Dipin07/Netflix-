...
import { SMALL_IMG_BASE_URL } from './utlis/constants'
...
const MovieSlider = ({ category }) => {
    ...
    const fromatedCategoryName = category.replaceAll("_", " ")[0].toUpperCase() + category.replaceAll("_", " ").slice(1)
    ...
    return (
        ...
        >
            <h2 className='mb-4 text-2xl font-bold'>
                {fromatedCategoryName} {formatedContentType}
            </h2>
